...
- Submit the final user-facing answer with `grid_submit_answer`; include `result_refs` and `claim_evidence_refs` as separate arrays, and include only references that exist in the current run.
