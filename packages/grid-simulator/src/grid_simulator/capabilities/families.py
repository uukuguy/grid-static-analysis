...
CAPABILITY_FAMILIES = (
    ...
    CapabilityFamilyStatus(id="topology", availability="published", reason="Endpoints, components, paths, neighbors, and supply analysis"),
    ...
    CapabilityFamilyStatus(id="contingency", availability="published", reason="AC/DC isolated single-branch outage analysis"),
    ...
    CapabilityFamilyStatus(id="protection", availability="published", reason="Static pandapower protection-device evaluation"),
